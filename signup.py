...
def _load_logo(filenames=("logo.png"), size=(140, 140)):
...
logo_label = ctk.CTkLabel(window, image=logo_image, text='', bg_color=BG)
logo_label.place(relx=0.5, rely=0.12, anchor='center')

heading = ctk.CTkLabel(window, text='Register Staff', font=('Segoe UI', 26, 'bold'), text_color=TEXT,
                       fg_color=PRIMARY, corner_radius=16, padx=24, pady=6)
heading.place(relx=0.5, rely=0.26, anchor='center')

form_card = ctk.CTkFrame(window, fg_color=CARD_BG, corner_radius=20)
form_card.place(relx=0.5, rely=0.6, anchor='center', relwidth=0.78, relheight=0.6)
...
username_label.grid(row=0, column=0, sticky='w', padx=32, pady=(0, 6))
...
password_entry.grid(row=3, column=0, sticky='ew', padx=(32, 4))
...
register_button.grid(row=6, column=0, columnspan=2, padx=32, pady=(36, 12), sticky='ew')

link_row = ctk.CTkFrame(form_card, fg_color='transparent')
link_row.grid(row=7, column=0, columnspan=2, padx=32, pady=(4, 6), sticky='e')
